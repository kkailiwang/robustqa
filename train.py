...
class Trainer():
    ...
    def train(self, model, train_dataloader, eval_dataloader, val_dict, ood_train_dataloader=None):
        ...
        def train_for_epochs(training_dataloader, num_epochs, global_idx, best_scores):
...
def get_dataset(args, datasets, data_dir, tokenizer, split_name, augment="original"):
...
def main():
    ...
    if args.do_train:
        ...
        train_dataset, _ = get_dataset(args, args.train_datasets, args.train_dir, tokenizer, 'train', "augmented")
        ood_train_dataset, _ = get_dataset(args, args.ood_train_datasets, args.ood_train_dir, tokenizer, 'train', "both")
